      ...
      return `
         <div class="swiper ${this.props.swiperclassname}">
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide ${this.props.swiperclassname}-slide">
                  <div class="container slide-container">
                     <div class="${this.props.swiperclassname}-slide__info">
                        <h3
                           class="${this.props.swiperclassname}-slide__info-title"
                        >
                           ${slide.title}
                        </h3>
                        ${slide.subtitle ? `
                        <p
                           class="${this.props.swiperclassname}-slide__info-subtitle"
                        >                
                           ${slide.subtitle}
                        </p>` : ''}
                        <div
                           class="${this.props.swiperclassname}-slide__info-bottom"
                        >
                           <gastro-button
                           ...
                           <p
                              class="${this.props.swiperclassname}-slide__info-test"
                           >
                              ${slide.subinfo.text}
                              ${slide.subinfo.price ? `
                              <span 
                                 class="${this.props.swiperclassname}-slide__info-test-price"
                              >
                                 ${slide.subinfo.price}
                              </span>`: ''}
                           </p>
                  ...
                  <div
                     class="${this.props.swiperclassname}-slide__circle-img"
                  >
                     <img
                        src="../../../assets/images/slides/${slide.src}" alt="Slide" 
                     />
                  </div>
               </div>`)).join('')}
            </div>
