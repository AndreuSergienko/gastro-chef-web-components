    ...
    return `
        ...
        <div class="diet__modes-content-shedule">
          <div class="diet__modes-content-shedule-days">
            <button type="button" class="diet__modes-content-shedule-day">пн</button>
            <button type="button" class="diet__modes-content-shedule-day">вт</button>
            <button type="button" class="diet__modes-content-shedule-day">ср</button>
            <button type="button" class="diet__modes-content-shedule-day">чт</button>
            <button type="button" class="diet__modes-content-shedule-day">пт</button>
            <button type="button" class="diet__modes-content-shedule-day">сб</button>
            <button type="button" class="diet__modes-content-shedule-day">вс</button>
          </div>
